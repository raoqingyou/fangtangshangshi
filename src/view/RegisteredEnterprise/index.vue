          ...
          <div class="fnorz-wrap">
            <div class="fnorz-top">
              ...
              <div class="select-information">
                <span class="organization-name">企业名称：</span>
                <input placeholder="请输入企业名称" type="text" class="ant-input" v-model="getFrom.keyword" style="width: 270px" />
                                ...
                                <tr>
                                  <th class="">
                                    <span class="ant-table-header-column"><div>
                                        <span class="ant-table-column-title">企业名称</span>
                                  ...
                                  <th class="ant-table-row-cell-break-word">
                                    <span class="ant-table-header-column"><div>
                                        <span class="ant-table-column-title">注册日期</span>
                                        <span class="ant-table-column-sorter"></span>
                                        </div>
                                    </span>
                                  </th>
...
export default {
  ...
  methods: {
    ...
    this.$axios({  //企业列表
      method: 'POST',
      url: '/api/index/getEnterpriseBasic',
      data: data
    }).then(res=>{
      let { data } = res.data
  ...
  skip (val,val2) { //跳转企业详情
    this.$router.push({path:'/registeredDetail', query:{id: val}})
    }
  }
};
</script>